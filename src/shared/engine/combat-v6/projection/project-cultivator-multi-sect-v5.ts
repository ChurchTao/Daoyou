...
export function projectCultivatorMultiSectV5ToCombatV6(input: ProjectCultivatorMultiSectToCombatV6Input): CombatV6ProjectionResult {
  ...
  const base = projectCultivatorWithEquipmentSpecialInternal({ ...input, cultivator: withManualAttributes(input.cultivator, manuals.projection) }, versions, true, true, true, true)
