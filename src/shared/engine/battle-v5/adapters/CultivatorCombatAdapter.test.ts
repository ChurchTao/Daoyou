...
describe('CultivatorCombatAdapter', () => {
  ...
  it('keeps wuxiang ability projection identical with or without body cultivation', () => {
    ...
    baseline.sect = {
      membershipId: 'wuxiang-member',
      sectId: 'wuxiang',
      status: 'active',
      contribution: 0,
      configVersion: 2,
      activePathId: 'demon-crossing',
      methods: {
        'wuxiang-canon': 5,
        'blood-lotus': 3,
        'white-bone': 3,
      ...
      paths: [
        {
          ...
          meridianLoadouts: [
            {
              slot: 1,
              nodeIds: ['demon-bone-tide', 'demon-one-furnace'],
              version: 1,
            },
    ...
    const describeAbilities = (cultivator: Cultivator) => {
      ...
      return abilities.map((ability) => ({
        ...
        cooldown:
          ability instanceof ActiveSkill ? ability.maxCooldown : undefined,
