...
export const WUXIANG_BASE_DEFINITION: SectDefinitionWithoutPaths = {
  ...
  abilities: [
    { id: 'flower-heart', kind: 'default', baseName: '拈花叩心', description: '指间拈花，叩问的却是敌我同一颗心。', role: 'generator', unlock: { type: 'method', methodId: 'wuxiang-canon', level: 1 }, cooldown: 0 },
    { id: 'blood-tide', kind: 'active', baseName: '血海听潮', description: '不拒血海来潮，先听清每一道苦声从何处生。', role: 'defensive', unlock: { type: 'method', methodId: 'blood-lotus', level: 1 }, cooldown: 3 },
    { id: 'three-knocks', kind: 'active', baseName: '三叩业门', description: '一叩问因，二叩问果，三叩时门内门外再无旁人。', role: 'combo', unlock: { type: 'method', methodId: 'white-bone', level: 3 }, cooldown: 2 },
    { id: 'observe-calamity', kind: 'active', baseName: '闭目观劫', description: '闭目并非不见，而是不被劫相夺去心神。', role: 'defensive', unlock: { type: 'method', methodId: 'wrathful-ming', level: 3 }, cooldown: 4 },
    { id: 'five-skandhas', kind: 'active', baseName: '照见五蕴', description: '色受想行识逐一照破，外法与我执皆无所藏。', role: 'utility', unlock: { type: 'method', methodId: 'six-senses', level: 3 }, cooldown: 3 },
    { id: 'reed-crossing', kind: 'active', baseName: '一苇横江', description: '江阔浪急，脚下只留一苇，心中却已有彼岸。', role: 'defensive', unlock: { type: 'method', methodId: 'reed-crossing-method', level: 3 }, cooldown: 5 },
    { id: 'turn-form', kind: 'active', baseName: '一念未生', description: '战意未足时，一念尚伏于心；战意既成，佛魔只在翻掌之间。', role: 'finisher', unlock: { type: 'method', methodId: 'wuxiang-canon', level: 5 }, cooldown: 0 },
