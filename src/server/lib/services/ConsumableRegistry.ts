import { CONSUMABLE_TOXICITY_DEFAULTS, getConsumableQualityScalar } from '@shared/config/consumableSystem';
import type { ConsumableQuotaKind, Quality } from '@shared/types/constants';
import type { Attributes, Consumable, ConsumableUseSpec } from '@shared/types/cultivator';
