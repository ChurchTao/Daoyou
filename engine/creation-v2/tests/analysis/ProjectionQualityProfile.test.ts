import { deriveProjectionQualityFromBudget } from '@/engine/creation-v2/analysis/ProjectionQualityProfile';
import type { EnergyBudget } from '@/engine/creation-v2/types';
