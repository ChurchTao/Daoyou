  ...
  describe('productType: skill', () => {
    ...
    it('有 damage 词缀时：policy 包含来自词缀的 damage effect', () => {
      const rolledAffix: RolledAffix = {
        ...
        category: 'core',
        energyCost: 8,
        rollScore: 1, rollEfficiency: 1, finalMultiplier: 1, isPerfect: false, effectTemplate: { type: "damage", params: { value: { base: 100, attribute: "magicAtk" } } } as any,
        weight: 10,
        tags: [],
      };
    ...
    it('heal 词缀时：targetPolicy 应为 self', () => {
      const healAffix: RolledAffix = {
        ...
        category: 'core',
        energyCost: 8,
        rollScore: 1, rollEfficiency: 1, finalMultiplier: 1, isPerfect: false, effectTemplate: { type: "heal", params: { value: { base: 10, attribute: "magicAtk" } } } as any,
        weight: 10,
        tags: [],
      };
        ...
        affixes: [
          {
            ...
            category: 'core',
            energyCost: 8,
            rollScore: 1, rollEfficiency: 1, finalMultiplier: 1, isPerfect: false, effectTemplate: { type: "attribute_modifier", params: { attrType: "vitality", modType: "fixed", value: 10 } } as any,
            weight: 10,
            tags: [],
          },
        ],
        ...
        affixes: [
          {
            ...
            category: 'core',
            energyCost: 8,
            rollScore: 1, rollEfficiency: 1, finalMultiplier: 1, isPerfect: false, effectTemplate: { type: "attribute_modifier", params: { modifiers: [{ attrType: "atk", modType: "fixed", value: 5 }, { attrType: "magicAtk", modType: "fixed", value: 5 }] } } as any,
            weight: 10,
            tags: [],
          },
        ],
        ...
        affixes: [
          {
            ...
            category: 'prefix',
            energyCost: 6,
            rollScore: 1, rollEfficiency: 1, finalMultiplier: 1, isPerfect: false, effectTemplate: { type: "attribute_stat_buff", params: { attrType: "spirit", modType: "fixed", value: 10 } } as any,
            weight: 10,
            tags: [],
          },
        ],
