/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 146617ba99680a24d7b9109f6d61db19)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		KIMI_MODEL_USE: string;
		KIMI_MODEL_FAST_USE: string;
		ARK_API_KEY: string;
		ARK_BASE_URL: string;
		ARK_MODEL_USE: string;
		ARK_MODEL_FAST_USE: string;
		NEXT_PUBLIC_SUPABASE_URL: string;
		NEXT_PUBLIC_SUPABASE_ANON_KEY: string;
		SUPABASE_AUTH_SERVICE_KEY: string;
		DATABASE_URL: string;
		REDIS_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROVIDER_CHOOSE" | "OPENAI_API_KEY" | "OPENAI_BASE_URL" | "OPENAI_MODEL" | "FAST_MODEL" | "KIMI_API_KEY" | "KIMI_BASE_URL" | "KIMI_MODEL_USE" | "KIMI_MODEL_FAST_USE" | "ARK_API_KEY" | "ARK_BASE_URL" | "ARK_MODEL_USE" | "ARK_MODEL_FAST_USE" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_AUTH_SERVICE_KEY" | "DATABASE_URL" | "REDIS_URL" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "CRON_SECRET" | "ADMIN_EMAILS" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_USER" | "SMTP_PASS" | "MAIL_FROM" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "DB_RUNTIME">> {}
}
