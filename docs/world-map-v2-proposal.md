...
素材进度：世界总览、天南与乱星海区域底画已接入 `/game/map-v2`，见[素材交付清单](game-map-art.md)。二级地图采用独立区域构图。美术规范统一维护在[国画水墨地图 skill](../.agents/skills/daoyou-map-art/SKILL.md)。
...
- 节点选中：轻量朱砂印记，弹出已有详情和动作。新版地图不绘制节点连线，也不展示跨区域连接提示；区域切换通过总览入口完成。
...
- 世界总览只显示区域入口；天南与乱星海使用独立底画，分别重新锚定现有 23 个、11 个地点。乱星海首次进入以天星城为镜头中心，支持区域入口、地点直达、筛选及新旧版切换。慕兰、大晋显示明确的旧版入口，保留已有地点和用途。
